            ...
            <div class="col-lg-offset-2 col-lg-8">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form:form action="/sprints/update" method="POST" modelAttribute="sprint" >
                            <div class="form-group col-lg-12 outer">
                                <form:hidden path="id" class="form-control" value="${updSprint.id}"/>
                                <div class="form-group col-lg-4">
                                    <label for="name">Title:</label>
                                    <form:input path="name" type="text" class="form-control" value="${updSprint.name}"/>
                            ...
                            <div class="form-group col-lg-12 outer">
                                <div class="form-group col-lg-6">
                                    ...
                                    <form:input path="startDate" type="date" class="form-control" value="${updSprint.startDate}"/>
                                    <form:errors path="startDate" cssClass="label label-danger"/>
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="endDate">End date:</label>
                                    <form:input path="endDate" type="date" class="form-control" value="${updSprint.endDate}"/>
                            ...
                            <div class="form-group col-lg-12 outer">
                                <div class="form-group col-lg-12">
                                    <p><b>Description: </b></p>
                                    <form:textarea path="description" id="description" rows="5" cssClass="text-area-margin" value="${updSprint.description}"/>
