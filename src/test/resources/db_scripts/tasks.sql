...
insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (5, 'Task 5', 13, 'OPEN', 'Some description', 7, 23, 3);
insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (6, 'Task 6', 7, 'RESOLVED', 'Some description', 7, 23, 3);
...
insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (9, 'Task 9', 4, 'OPEN', 'Some description', 9, 23, 4);
...
insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (13, 'Task 13', 10, 'OPEN', 'Some description', 12, 24, 6);

insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (14, 'Task 14', 16, 'OPEN', 'Some description', 13, 25, 7);
insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (15, 'Task 15', 5, 'RESOLVED', 'Some description', 14, 25, 7);
insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (16, 'Task 16', 17, 'RESOLVED', 'Some description', 15, 25, 7);
...
insert into task (id, name, estimate, status, description, assigner_id, creator_id, sprint_id) values (18, 'Task 18', 9, 'RESOLVED', 'Some description', 15, 25, 8);
